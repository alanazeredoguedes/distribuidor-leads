<template>
  <div class="modal fade" id="modalCriarFormulario" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog mw-1000px">
      <div class="modal-content">
        <div class="modal-header">
          <h2>Criar Novo Formulário</h2>
          <div class="btn btn-sm btn-icon btn-active-color-primary" @click="close" data-bs-dismiss="modal">
