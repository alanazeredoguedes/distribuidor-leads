      ...
      <div class="modal-content">
        ...
        <div class="modal-body scroll-y mx-5 mx-xl-10 pt-0 pb-15">
          ...
          <div class="mh-475px scroll-y me-n7 pe-7">
            ...
            <div class="border border-hover-primary p-7 rounded mb-7" v-for="integration in integrations">
                  ...
                  <div class="d-flex flex-stack">
                    <div class="d-flex flex-column mw-200px">
                      <div class="d-flex align-items-center mb-2">
                        <span class="text-gray-700 fs-6 fw-semibold me-2">100%</span>
                    ...
                    <a href="javascript:void(0)" @click="addIntegration(integration.id)" class="btn btn-sm btn-primary">Selecionar</a>
                  </div>
                </div>
              </div>
            </div>
