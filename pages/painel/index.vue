    ...
    <div class="row g-5 g-xl-8">
        ...
        <div class="card card-flush h-xl-100">
          <div class="card-header rounded bgi-no-repeat bgi-size-cover bgi-position-y-top bgi-position-x-center align-items-start h-250px" style="background-image:url('assets/media/svg/shapes/top-green.png')" data-theme="light">
            <h3 class="card-title align-items-start flex-column text-white pt-15">
              <span class="fw-bold fs-2x mb-3">Estatística Globais</span>
              <div class="fs-4 text-white">
                <span class="opacity-75">Estatística gerais sobre o sistema.</span>
              </div>
            </h3>
                ...
                <div class="col-6">
                  <div class="bg-gray-100 bg-opacity-70 rounded-2 px-6 py-5">
                    ...
                    <div class="m-0">
                      ...
                      <span class="text-gray-500 fw-semibold fs-6">Fomulários</span>
                    </div>
                  </div>
                </div>
                <div class="col-6">
                  <div class="bg-gray-100 bg-opacity-70 rounded-2 px-6 py-5">
                    ...
                    <div class="m-0">
                      ...
                      <span class="text-gray-500 fw-semibold fs-6">Empresas</span>
                    </div>
                  </div>
                </div>
                <div class="col-6">
                  <div class="bg-gray-100 bg-opacity-70 rounded-2 px-6 py-5">
                    ...
                    <div class="m-0">
                      <span class="text-gray-700 fw-bolder d-block fs-2qx lh-1 ls-n1 mb-1">35</span>
                      <span class="text-gray-500 fw-semibold fs-6">Usuários</span>
                    </div>
                  </div>
                </div>
                <div class="col-6">
                  <div class="bg-gray-100 bg-opacity-70 rounded-2 px-6 py-5">
                    ...
                    <div class="m-0">
                      <span class="text-gray-700 fw-bolder d-block fs-2qx lh-1 ls-n1 mb-1">742</span>
                      <span class="text-gray-500 fw-semibold fs-6">Leads</span>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div class="col-xl-8">
        <div class="row gx-5 gx-xl-8 mb-5 mb-xl-8">
          ...
          <!--            <router-link :to="{name: 'empresas_list'}" class="col-xl-3">
                      <div class="card h-200px bgi-no-repeat bgi-size-cover card-xl-stretch" style="background-image:url('assets/media/stock/600x400/img-75.jpg')">
                        <div class="card-body p-6">
                            <div class="text-black text-hover-primary fw-bold fs-2">Empresas</div>
                        </div>
                      </div>
                    </router-link>-->
                ...
                <div class="m-0">
                  <div class="position-relative fs-2x z-index-2 fw-bold text-white mb-7">
                          ...
                          <span class="position-relative d-inline-block text-danger">
                            <a href="javascript:void(0)" class="text-danger opacity-75-hover">Sistema de Integração</a>
                ...
                <div class="row align-items-center h-100">
                  <div class="col-7 ps-xl-13">
                    <div class="text-white mb-6 pt-6">
                      <span class="fs-2qx fw-bold">Gerenciar Formulários</span>
                    </div>
                    <span class="fw-semibold text-white fs-6 mb-8 d-block opacity-75">Gerencie os formulários de diversas empresas em um só lugar.</span>
                    <div class="d-flex align-items-center flex-wrap d-grid gap-2 mb-10 mb-xl-20">
                      <div class="d-flex align-items-center me-5 me-xl-13">
                        ...
                        <div class="text-white">
                          <span class="fw-semibold d-block fs-8 opacity-75">Formulários Criados</span>
                          <span class="fw-bold fs-7">Mais de 500</span>
                        </div>
                      </div>
                      <div class="d-flex align-items-center">
                        ...
                        <div class="text-white">
                          <span class="fw-semibold opacity-75 d-block fs-8">Empresas</span>
                          <span class="fw-bold fs-7">16</span>
                        </div>
                      </div>
                    </div>
