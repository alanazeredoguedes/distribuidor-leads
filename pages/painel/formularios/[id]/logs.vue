    ...
    <div class="card-header card-header-stretch">
      ...
      <div class="card-toolbar m-0">
        <ul class="nav nav-tabs nav-line-tabs nav-stretch fs-6 border-0 fw-bold" role="tablist">
          ...
          <li class="nav-item" role="presentation">
            <a id="kt_activity_year_tab" class="nav-link justify-content-center text-active-gray-800 text-hover-gray-800" data-bs-toggle="tab" role="tab" href="#kt_activity_year" aria-selected="false" tabindex="-1">2022</a>
          </li>
        </ul>
      </div>
    </div>
          ...
          <div class="timeline">
            <div class="timeline-item">
              ...
              <div class="timeline-content mb-10 mt-n1">
                ...
                <div class="pe-3 mb-5">
                  <div class="fs-5 fw-semibold mb-2">Integração Portal do Corretor:</div>
                  <div class="d-flex align-items-center mt-1 fs-6">
                    <div class="text-muted me-2 fs-7">Criada as 4:23 PM</div>
                  </div>
                </div>
          ...
          <div class="timeline">
            <div class="timeline-item">
              ...
              <div class="timeline-content mb-10 mt-n1">
                ...
                <div class="pe-3 mb-5">
                  <div class="fs-5 fw-semibold mb-2">Integração Novo CRM:</div>
                  <div class="d-flex align-items-center mt-1 fs-6">
                    <div class="text-muted me-2 fs-7">Criada as 4:23 PM</div>
                  </div>
                </div>
